...
<div id="app">
              ...
              <ul class="dropdown__menu-nav">
                <li class="dropdown__menu-item">
                  <a href="#" class="dropdown__menu-link" title="Home">
                    ...
                    <div class="dropdown__menu-text">
                      <router-link to="/" class="styled-link">Home</router-link>
                    </div>
                  </a>
                </li>
                ...
                <li class="dropdown__menu-item">
                  <a href="#" class="dropdown__menu-link" title="Recipes">
                    ...
                    <div class="dropdown__menu-text">
                      <router-link to="/recipes" class="styled-link">Recipes</router-link>
                    </div>
                  </a>
                </li>
                
                <li class="dropdown__menu-item">
                  <a href="#" class="dropdown__menu-link" title="Share recipe">
                    <div class="dropdown__menu-svg">
                    ...
                    <div class="dropdown__menu-text">
                      <router-link to="/share-recipe" class="styled-link">Share recipe</router-link>
                    </div>
                  </a>
                </li> 
                ...
                <li class="dropdown__menu-item">
                  <a href="#" class="dropdown__menu-link" title="Profile">
                    ...
                    <div class="dropdown__menu-text">
                      <router-link to="/profile" class="styled-link">Profile</router-link>
                    </div>
                  </a>
                </li>
                ...
                <li class="dropdown__menu-item">
                  <a href="#" class="dropdown__menu-link" title="About">
                    ...
                    <div class="dropdown__menu-text">
                      <router-link to="/about" class="styled-link">About</router-link>
                    </div>
                  </a>
                </li> 
  ...
  <footer class="footer">
    Copyright 2021, Marko Vitiz, Jasna Marin, Odsek za softversko inzenjerstvo Elektrotehnickog fakulteta Univerziteta u Beogradu
  </footer>
